...
public class ProductController {
    ...
    public ResponseEntity<Product> createProduct(@RequestBody ProductCreateDTO dto) {
        ...
        Product created = warehouseFacade.registerProductWithInitialStock(
                product,
                dto.getInitialQuantity() != null ? dto.getInitialQuantity() : 0,
                1L // TODO: отримувати userId з сесії
        );
     ...
     */
    @GetMapping("/search")
    public ResponseEntity<Product> searchByArticle(@RequestParam String article) {
